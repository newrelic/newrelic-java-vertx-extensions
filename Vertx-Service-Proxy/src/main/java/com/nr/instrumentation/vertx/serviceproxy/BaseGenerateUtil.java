...
//			sb.append(pathSeparator);
		...
		NewRelic.getAgent().getLogger().log(Level.FINE, "Compiling with options: {0} and compilationUnits: {1}", optionList, generatedJavaFiles);
	...
	protected static File getExtensionsDirectory() {
