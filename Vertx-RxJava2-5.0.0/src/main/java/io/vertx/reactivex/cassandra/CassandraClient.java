...
import com.nr.instrumentation.vertx.rxjava2.NRCompletionConsumer;
import com.nr.instrumentation.vertx.rxjava2.NRErrorConsumer;
import com.nr.instrumentation.vertx.rxjava2.NRHolder;
import com.nr.instrumentation.vertx.rxjava2.NRSubscribeConsumer;
import com.nr.instrumentation.vertx.rxjava2.NRTerminateAction;
...
public abstract class CassandraClient {
    ...
    public Single<ResultSet> rxExecute(Statement statement) {
        ...
        Consumer<ResultSet> completeConsumer = new NRCompletionConsumer<>(holder);
