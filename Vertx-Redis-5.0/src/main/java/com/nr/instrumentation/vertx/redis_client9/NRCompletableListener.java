...
public class NRCompletableListener<T> implements Completable<T> {
	...
	public void complete(T result, Throwable failure) {
		AgentBridge.getAgent().getLogger().log(Level.FINEST, "Gulab Complete called");
		...
		if (token != null) {
			...
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Token linked and expired in NRCompletableListener complete");
		}
	...
	public void succeed(T result) {
		...
		if (token != null) {
			...
			token = null;
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Token linked and expired in NRCompletableListener succeed(result)");
		}
		...
		if (segment != null) {
			...
			segment = null;
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Segment ended in NRCompletableListener succeed(result)");
		}
	...
	public void fail(Throwable failure) {
		...
		if (token != null) {
			...
			token = null;
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Token linked and expired in NRCompletableListener fail(throwable)");
		}
		...
		if (segment != null) {
			...
			segment = null;
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Segment ended in NRCompletableListener fail(throwable)");
		}
	...
	public void fail(String message) {
		...
		if (token != null) {
			...
			token = null;
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Token linked and expired in NRCompletableListener fail(message)");
		}
		...
		if (segment != null) {
			...
			segment = null;
			AgentBridge.getAgent().getLogger().log(Level.FINEST,
					"Segment ended in NRCompletableListener fail(message)");
		}
	}
