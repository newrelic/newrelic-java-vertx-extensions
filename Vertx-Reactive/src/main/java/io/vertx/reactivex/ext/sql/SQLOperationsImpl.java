...
abstract class SQLOperationsImpl {

	@Trace
	public SQLOperations call(String sql, Handler<AsyncResult<ResultSet>> handler) { 
	...
	@Trace
	public SQLOperations query(String sql, Handler<AsyncResult<ResultSet>> handler) { 
		NRHandlerWrapper<ResultSet> wrapper = new NRHandlerWrapper<ResultSet>(handler, NewRelic.getAgent().getTransaction().getToken());
		handler = wrapper;
		return Weaver.callOriginal();
	}
	...
	public SQLOperations queryStream(String sql, Handler<AsyncResult<SQLRowStream>> handler) { 
	...
	@Trace
	public SQLOperations queryStreamWithParams(String sql, JsonArray params, Handler<AsyncResult<SQLRowStream>> handler) { 
		NRHandlerWrapper<SQLRowStream> wrapper = new NRHandlerWrapper<SQLRowStream>(handler, NewRelic.getAgent().getTransaction().getToken());
		handler = wrapper;
		return Weaver.callOriginal();
	}
	...
	@Trace
	public SQLOperations queryWithParams(String sql, JsonArray arguments, Handler<AsyncResult<ResultSet>> handler) { 
		NRHandlerWrapper<ResultSet> wrapper = new NRHandlerWrapper<ResultSet>(handler, NewRelic.getAgent().getTransaction().getToken());
		handler = wrapper;
		return Weaver.callOriginal();
	}
	...
	@Trace
	public SQLOperations update(String sql, Handler<AsyncResult<UpdateResult>> handler) { 
	...
	@Trace
	public SQLOperations updateWithParams(String sql, JsonArray params, Handler<AsyncResult<UpdateResult>> handler) { 
		NRHandlerWrapper<UpdateResult> wrapper = new NRHandlerWrapper<UpdateResult>(handler, NewRelic.getAgent().getTransaction().getToken());
		handler = wrapper;
		return Weaver.callOriginal();
	}
	...
	@Trace
	public SQLOperations callWithParams(String sql, JsonArray params, JsonArray outputs, Handler<AsyncResult<ResultSet>> handler) { 
		NRHandlerWrapper<ResultSet> wrapper = new NRHandlerWrapper<ResultSet>(handler, NewRelic.getAgent().getTransaction().getToken());
		handler = wrapper;
		return Weaver.callOriginal();
	}
